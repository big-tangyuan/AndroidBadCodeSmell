...
import tang.JdtAst.Visitor.LogVisitor;
 ...
 * @Author TangZT
 */
public class LogDec extends BadSmellDec {
    private ArrayList<CodeSmell> codeSmells;
    private File file;

    public LogDec(ArrayList<CodeSmell> codeSmells, File file){
    ...
    public void codeDec(CompilationUnit cu){
        ...
        for(TypeDeclaration type : types){
            ...
            for(MethodDeclaration method : methods){
                ...
                LogVisitor visitor = new LogVisitor(codeSmells, file, type);
